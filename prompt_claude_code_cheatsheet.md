...
- [x] Zecche: zone e quote a rischio, prevenzione, rimozione corretta, sintomi di
...
- [x] Altimetro barometrico: taratura, deriva col meteo, uso per orientarsi.
- [x] Orientarsi in nebbia o al buio: navigazione a bussola, conteggio passi,
...
- [x] Finestra meteo: leggere modelli e tendenze a 2–5 giorni senza illudersi.
- [x] Neve fuori stagione e gelo notturno: soglie realistiche per mese e quota
      sulle Alpi centrali.
